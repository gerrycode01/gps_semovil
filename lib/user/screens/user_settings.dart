...
class _UserSettingsState extends State<UserSettings> {
  ...
  Widget build(BuildContext context) {
    bool isLargeScreen = MediaQuery.of(context).size.width >
        600; // Considera 600px como el breakpoint para una pantalla grande
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
          ...
          IconButton(
            ...
            onPressed: () {
              Navigator.push(
                      ...
                      MaterialPageRoute(
                          builder: (context) =>
                              ChangeUserData(userModel: widget.userModel)))
                  .then((value) => setState(() {}));
            },
          ),
        ],
      ...
      body: AnimationLimiter(
        child: ListView(
          ...
          // Mayor padding en pantallas grandes
          children: AnimationConfiguration.toStaggeredList(
            ...
            children: [
              ...
              userInfoCard('Apellido Paterno', widget.userModel.lastname,
                  Icons.person_outline),
              userInfoCard('Apellido Materno', widget.userModel.lastname2!,
                  Icons.person_outline),
              userInfoCard('Número de Teléfono', widget.userModel.phone ?? "",
                  Icons.phone),
              userInfoCard('Tipo de Sangre', widget.userModel.bloodtype ?? "",
                  Icons.bloodtype),
              userInfoCard('Correo Electrónico', widget.userModel.email ?? "",
                  Icons.email),
              const SizedBox(
                height: 10,
              ),
    ...
    return Card(
      ...
      margin: EdgeInsets.symmetric(
          ...
          horizontal: MediaQuery.of(context).size.width > 600
              ? 100
              : 8), // Menos margen en pantallas más anchas
      child: ListTile(
        ...
        title: Text(title,
            style: const TextStyle(
                ...
                color: Colors.white)),
        subtitle: Text(value,
            style: TextStyle(fontSize: 18, color: Design.lightOrange)),
      ),
    );
  }
